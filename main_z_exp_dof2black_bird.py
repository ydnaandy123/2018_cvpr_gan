...
tf.flags.DEFINE_integer("data_size", 4000, "data size for training")
...
def main(args=None):
    ...
    with tf.variable_scope('Network'):
        ...
        segment_a = generator_z(real_a, flags, False, name="Generator_A2B")
        segment_a_test = generator_z(real_a_test, flags, True, name="Generator_A2B")
