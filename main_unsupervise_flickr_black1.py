...
tf.flags.DEFINE_string('dataset_dir', "./dataset/flickr_black", "directory of the dataset")
                ...
                while True:
                    try:
                        ...
                        if image_idx % 1 == 0:
                            ...
                            x_png.save('{}/{}_{}_2_binary.png'.format(dataset_parser.logs_image_val_dir, image_idx,
                                                                      real_a_name_sess[0].decode()), format='PNG')
