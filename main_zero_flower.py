...
def main(args=None):
    ...
    with tf.variable_scope('Network'):
        ...
        segment_a_0, segment_a_1, segment_a_2 = generator_zero(real_a, flags, False, name="Generator_A2B")
        fake_b_0 = blend_fake_b(real_a, adjusted_a, segment_a_0, name='fake_b_0')
        fake_b_1 = blend_fake_b(real_a, adjusted_a, segment_a_1, name='fake_b_1')
        fake_b_2 = blend_fake_b(real_a, adjusted_a, segment_a_2, name='fake_b_2')
        segment_a = (0.2 * segment_a_0) + (0.3 * segment_a_1) + (0.5 * segment_a_2)
        fake_b = blend_fake_b(real_a, adjusted_a, segment_a, name='fake_b')

        #
        fake_b_0_f = tf.reshape(fake_b_0, [-1, image_linear_shape], name='fake_b_0_f')
        fake_b_1_f = tf.reshape(fake_b_1, [-1, image_linear_shape], name='fake_b_1_f')
        fake_b_2_f = tf.reshape(fake_b_2, [-1, image_linear_shape], name='fake_b_2_f')
        ...
        dis_fake_b_0 = discriminator_rule(fake_b_0_f, flags, reuse=False, name="Discriminator_B")
        dis_fake_b_1 = discriminator_rule(fake_b_1_f, flags, reuse=True, name="Discriminator_B")
        dis_fake_b_2 = discriminator_rule(fake_b_2_f, flags, reuse=True, name="Discriminator_B")
        ...
        with tf.name_scope('loss_gen_a2b'):
            loss_gen_a2b_s0 = -tf.reduce_mean(dis_fake_b_0)
            loss_gen_a2b_s1 = -tf.reduce_mean(dis_fake_b_1)
            loss_gen_a2b_s2 = -tf.reduce_mean(dis_fake_b_2)
            # loss_gen_a2b = (0.2 * loss_gen_a2b_s0) + (0.3 * loss_gen_a2b_s1) + (0.5 * loss_gen_a2b_s2)
            loss_gen_a2b = loss_gen_a2b_s0 + loss_gen_a2b_s1 + loss_gen_a2b_s2
    ...
    with tf.variable_scope('GEN_a2b'):
        tf.summary.scalar("loss/gen_a2b/s0", loss_gen_a2b_s0)
        tf.summary.scalar("loss/gen_a2b/s1", loss_gen_a2b_s1)
        tf.summary.scalar("loss/gen_a2b/s2", loss_gen_a2b_s2)
                    ...
                    try:
                        ...
                        if flags.debug and global_step_sess % flags.observe_freq == 1:
                            ...
                            dataset_parser.visualize_data_zero(
                                ...
                                segment_a_0=segment_a_0_sess, segment_a_1=segment_a_1_sess,
                                segment_a_2=segment_a_2_sess)
                        """
