...
from module import generator_final, discriminator_wgangp, high_light
import time
...
def main(args=None):
    ...
    with tf.Graph().as_default():
        ...
        with tf.name_scope('Network'):
            ...
            segment_a = generator_final(real_a, flags, False, name="Generator_A2B")
            segment_a_test = generator_final(real_a_test, flags, True, name="Generator_A2B")
