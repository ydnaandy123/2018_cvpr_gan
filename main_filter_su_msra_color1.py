...
tf.flags.DEFINE_string('dataset_dir', "./dataset/filter_su_msra_color", "directory of the dataset")
...
tf.flags.DEFINE_integer("training_iter", 12000, "data size for training")
