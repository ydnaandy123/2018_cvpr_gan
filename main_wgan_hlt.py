...
def main(args=None):
    ...
    with tf.variable_scope('Network'):
        ...
        # A -> B
        segment_a = generator_resnet(real_a, flags, False, name="Generator_A2B")
        ...
        dis_fake_b = discriminator_se(fake_b, flags, reuse=False, name="Discriminator_B")
        dis_fake_b_pool = discriminator_se(fake_b_pool, flags, reuse=True, name="Discriminator_B")
        dis_real_b = discriminator_se(real_b, flags, reuse=True, name="Discriminator_B")
