...
def main(args=None):
    ...
    with tf.variable_scope('Network'):
        ...
        fake_b_pool = tf.placeholder(tf.float32, shape=[None, 256, 256, 3], name='fake_B_pool')
        ...
        dis_fake_b_pool = discriminator_wgangp(fake_b_pool_f, flags, reuse=True, name="Discriminator_B")
